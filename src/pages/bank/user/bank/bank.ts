...
export class BankUserPage {
  ...
  saveScore() {
    if (this.email == null) {
      ...
      let Ref = this.afDatabase.list('score/bank/' + this.key)
      let params = {
        eamil: this.email,
        score: this.score
      }
  ...
  goToCommentPage() {
    let profileModal = this.modalCtrl.create(BankCommentPage, {
      key: this.key
    })
  ...
  update(key) {
    let profileModal = this.modalCtrl.create(BankCommentModalPage, {
      key: this.key,
      commentKey: key
    })
    profileModal.present()
  ...
  onSubmit(myform) {
    if (this.email == null) {
      ...
      let Ref = this.afDatabase.list('comment/bank/' + this.key)
      let params = {
        eamil: this.email,
